  ...
  const availableSchemas = [
    {
      ...
      agents: {
        collector: { type: "GreenField-SensorCollection" },
        broadcaster: { type: "BSCConnector" },
        responder: { type: "TemperatureAnalysis" },
      },
      deployedWorkflows: 1,
    },
    {
      ...
      agents: {
        calibration: { type: "DeviceCalibrator" },
        collector: { type: "GreenField-GeotaggedDecibelCollection" },
        broadcaster: { type: "BSCConnector" },
        responder: { type: "NoisePatternReporting" },
      },
      deployedWorkflows: 2,
    },
  ];
